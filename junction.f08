...
contains
    ...
    subroutine junction_branch_velocity_and_flowrate_proportional_to_area &
        ...
        real(4),      pointer :: area(:), totalarea(:), totalflowrate(:)
        real(4),      pointer :: flowrate(:), velocity(:)
