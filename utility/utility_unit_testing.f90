...
!%
    subroutine util_utest_CLprint (inputstring)
      ...
      !% --- USEFUL HEADER -----------------------------------------------
            ...
            ! print *, ' '
            ! print *, 'depth face 2',faceR(2,fr_Depth_u)
            ! ! retur
      ...
      !   return
         ...
         !          print *, ' '
            ...
            !          print *, ' '
            !    !% NJ2
               !       write(*,"(A9,17A11)"),' ','faceU','faceD','elem','faceU','faceD','elem','faceU','faceD','elem','faceU','faceD','elem','faceU','faceD','elem','faceU','faceD'
