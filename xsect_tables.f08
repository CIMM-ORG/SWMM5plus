...
!% A/Afull v. Y/Yfull
 ...
 real, dimension(NACirc) :: ACirc = (/ 0.0, 0.00471, 0.0134, 0.024446, 0.0374, 0.05208, 0.0680, 0.08505, 0.1033, 0.12236,    &
...
!% R/Rfull v. Y/Yfull
 ...
 real, dimension(NRCirc) :: RCirc = (/ 0.01, 0.0528, 0.1048, 0.1556, 0.2052, 0.2540, 0.3016, 0.3484, 0.3944, 0.4388, 0.4824, &
...
!%W/Wmax v. Y/Yfull
 ...
 real, dimension(NWCirc) :: WCirc = (/ 0.0, 0.2800, 0.3919, 0.4750, 0.5426, 0.6000, 0.6499, 0.6940, 0.7332, 0.7684, 0.8000,  &
