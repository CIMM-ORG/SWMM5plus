...
contains
   ...
   subroutine utility_print_values_by_link &
      ...
      eStart = minloc(elem2I(:,e2i_link_Pos),1,(  (elem2I(:,e2i_link_ID) == ilink) .and. (elem2I(:,e2i_link_Pos) /= nullvalueI) ) )
      eEnd   = maxloc(elem2I(:,e2i_link_Pos),1,(  (elem2I(:,e2i_link_ID) == ilink) .and. (elem2I(:,e2i_link_Pos) /= nullvalueI) ) )
