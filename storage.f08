...
! 
 ...
 real,      pointer :: volume, depth, fullvolume, fulldepth
 real,      pointer :: surfarea, aConst, aCoeff, aExpon
...
! indexes for old/new volume and velocity storage
 ...
 real,      pointer     :: fQ(:), dV(:), volumeMold(:), volumeMnew(:)
...
! indexes for old/new volume and velocity storage
 ...
 real,      pointer :: volumeMnew, depth, eta, fulldepth, fullvolume, zbottom
 real,      pointer :: aConst, aCoeff, aExpon
 integer,   pointer :: cindx
