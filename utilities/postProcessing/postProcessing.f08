...
subroutine get_specific_link_data &
    ...
    real(4), dimension(:,:), allocatable, intent(inout):: link_data
    real(4), dimension(:), allocatable, intent(inout)  :: link_lengths        
    real(4), dimension(:,:), allocatable, intent(out)  :: specific_linkData
    real(4), dimension(:,:), allocatable, intent(inout)  :: link_long_data
    real(4), dimension(:),   allocatable, intent(inout)  :: link_long_lengths, z_bottoms
...
subroutine get_longitudinal_link_data &
    ...
    real(4), dimension(:), allocatable                 :: link_long_data_temp
    real(4), dimension(:), allocatable                 :: link_data_temp1, link_data_temp2
    real(4), dimension(:,:), allocatable, intent(out)  :: link_long_data
    real(4), dimension(:),   allocatable, intent(out)  :: link_long_lengths, z_bottoms
...
subroutine get_all_link_data &
    ...
    integer, dimension(:), intent(in)               :: data_idx     
    integer                                         :: istat, nn
    real(4), dimension(:), allocatable                 :: link_data_temp
    real(4), dimension(:,:), allocatable, intent(out)  :: link_data
...
subroutine get_link_lengths &
    ...
    real(4), dimension(:), allocatable                 :: link_lengths_temp
    real(4), dimension(:), allocatable, intent(out)    :: link_lengths
