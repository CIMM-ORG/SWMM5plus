...
contains
    ...
    subroutine utility_export_linknode_csv()
        ...
        write(1, '(A)') "lr_Length,lr_InletOffset,lr_OutletOffset,lr_BreadthScale," // &
        ...
        write(2, '(A)') "li_idx,li_link_type,li_weir_type,li_orif_type," // &
        ...
        write(3, '(A)') "nr_Zbottom,nr_InitialDepth,nr_FullDepth,nr_StorageConstant,nr_StorageCoeff," // &
                        ...
                        "nr_ElementLength_u2,nr_ElementLength_u3,nr_ElementLength_d1,nr_ElementLength_d2,nr_ElementLength_d3"

        write(4, '(A)') "ni_idx,ni_node_type,ni_N_link_u,ni_N_link_d,ni_curve_type,ni_assigned,ni_total_inflow," // &
