module define_xsect_tables
    ...
    !==========================================================================
    !% Y/Yfull v. A/Afull
    integer, parameter :: NYCayenary = 51
    real(8), dimension(NYCayenary) :: YCatenary = (/0.0, 0.02974, 0.06439, 0.08433, 0.10549, &
    ...
    integer, parameter :: NACayenary = 51
    real(8), dimension(NACayenary) :: ACatenary = (/0.0, 0.01345, 0.02592, 0.03747, 0.05566, &
        ...
        1.0 /)
    !% S/Sfull v. Y/Yfull (Used for hydraulic radius)
    integer, parameter :: NSCayenary = 51
    real(8), dimension(NSCayenary) :: SCatenary = (/0.0, 0.00605, 0.01455, 0.0254,  0.03863, &
        ...
        1.0 /)
    !%T/Tmax v. Y/Yfull
    integer, parameter :: NTCayenary = 21
    real(8), dimension(NTCayenary) :: TCayenary = (/0.0,    0.6667,  0.8222,  0.9111,  &
