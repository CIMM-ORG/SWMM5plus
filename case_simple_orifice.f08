...
!
! Custom test case for a simple orifice created with with 4 nodes and 3 links
...
contains
    ...
    !==========================================================================
    !
    subroutine case_simple_orifice_initialize &
        ...
        call case_simple_orifice_and_nodes &
            (channel_length, channel_breadth, subdivide_length, lowerZ, upperZ, &
            initial_flowrate, depth_upstream, depth_dnstream, initial_depth,    &
            side_slope, inlet_offset, discharge_coefficient1,                   &
            discharge_coefficient2, full_depth, end_contractions, ManningsN,    &
    ...
    end subroutine case_simple_orifice_initialize
    !
    !==========================================================================
    !
    ! PRIVATE BELOW HERE
    !
    !==========================================================================
    subroutine case_simple_orifice_and_nodes &
        (channel_length, channel_breadth, subdivide_length, lowerZ, upperZ,  &
        initial_flowrate, depth_upstream, depth_dnstream, initial_depth,    &
        side_slope, inlet_offset, discharge_coefficient1,                   &
        discharge_coefficient2, full_depth, end_contractions, ManningsN,    &
        ...
        if ((debuglevel > 0) .or. (debuglevelall > 0))  print *, '*** leave ',subroutine_name
    end subroutine case_simple_orifice_and_nodes
    !
end module case_simple_orifice
