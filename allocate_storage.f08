...
contains
    ...
    subroutine allocate_data_storage &
        ...
        real(8),       dimension(:,:), allocatable, target, intent(out)    :: elem2R       ! real data for elements
        ...
        real(8),       dimension(:,:), allocatable, target, intent(out)    :: elemMR       ! real data for elements
        ...
        real(8),       dimension(:,:), allocatable, target, intent(out)    :: faceR       ! real data for faces
