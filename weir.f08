...
contains
    ...
    subroutine weir_step &
        ...
        real(8),  pointer     ::  wBreadth(:), wInletoffset(:), cTriangular(:), cRectangular(:)
        real(8),  pointer     ::  wFullDepth(:), wZbottom(:), wSideSlope(:), wEndContractions(:)
        real(8),  pointer     ::  wFlow(:), wEta(:), wLength(:), wArea(:), hEffective(:)
        real(8),  pointer     ::  wPerimeter(:), wHyddepth(:), wHydradius(:), wTopwidth(:)
        real(8),  pointer     ::  lEffective(:), wCrest(:), wCrown(:), cOrif(:)
        real(8),  pointer     ::  subFactor1(:), subFactor2(:)
    ...
    subroutine weir_initialize &
        ...
        real(8),  pointer   :: inletoffset(:), zbottom(:), crown(:)
        real(8),  pointer   :: crest(:), fullDepth(:), length(:), eta(:)
    ...
    subroutine weir_surcharge_coefficient &
        ...
        real(8),    pointer ::  flow(:), sideslope(:), cTrig(:), cRect(:), breadth(:), area(:)
        real(8),    pointer ::  fulldepth(:), endcontractions(:), crestlength(:)
        real(8),    pointer ::  submergenceFactor1(:), submergenceFactor2(:), corif(:)
    ...
    subroutine weir_effective_head &
        ...
        real(8),  pointer   :: crest(:), crown(:), effectivehead(:)
        real(8),  pointer   :: faceEtaUp(:), faceEtaDn(:), eta(:)
    ...
    subroutine weir_geometry &
        ...
        real(8),  pointer     ::  breadth(:), slope(:), area(:)
    ...
    subroutine weir_effective_crest_length &
        ...
        real(8),  pointer                     :: endcontractions(:), fulldepth(:)
        real(8),  pointer                     :: depth(:), breadth(:), sideslope(:)
        real(8),  pointer                     :: crestlength(:)
    ...
    subroutine villemonte_weir_submergence_correction &
        ...
        real(8),  pointer ::  crest(:), submergenceFactor1(:), submergenceFactor2(:)
        real(8),  pointer ::  faceEtaDn(:), faceEtaUp(:)
    ...
    subroutine weir_flow &
        ...
        real(8),  pointer   ::  volume2new(:), velocity2new(:), volumeMnew(:), velocityMnew(:)
        real(8),  pointer   ::  flow(:), area(:), sideslope(:), cTrig(:), cRect(:)
        real(8),  pointer   ::  submergenceFactor1(:), submergenceFactor2(:)
        real(8),  pointer   ::  effectivehead(:), crestlength(:)
    ...
    subroutine weir_surcharge_flow &
        ...
        real(8),    pointer ::  volume2new(:), velocity2new(:), volume2old(:), velocity2old(:)
        real(8),    pointer ::  crest(:), crown(:), eta(:), flow(:), area(:), cOrif(:)
        real(8),    pointer ::  effectivehead(:), faceEtaup(:), faceEtadn(:)
