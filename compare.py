...
testd = os.path.join(cwd, 'build/test')
print('test directory')
os.system('mkdir ' + testd)
...
output_dir = os.path.join(testd, inp_name+'comparison')
...
os.system('mkdir ' + os.path.join(output_dir, time_now))
...
out_path = os.path.join(output_dir_timestamped, inp_name, '.out')
print('out path with os.path.join', out_path)
