...
!% get the upper time
 ...
 call bc_applied_onelement (elem2R, bcdataDn, bcdataUp, thistime, bc_category_inflowrate,e2r_Velocity) 
 call bc_applied_onelement (elem2R, bcdataDn, bcdataUp, thistime, bc_category_elevation, idummy)     
 ...
 restartStep = restartStep + 1   ! required for diagnostics so end of first step is index 2
        ...
        if (mod(thisstep,setting%Debugout%DisplayInterval) == 0) then
            ...
            call debug_output &
                (debugfile, elem2R, elem2I, elem2YN, elemMR,  &
                 elemMI, elemMYN, faceR, faceI, faceYN,bcdataUp, bcdataDn)   
