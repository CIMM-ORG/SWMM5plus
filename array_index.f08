...
!%  faceI ARRAY COLUMN INDEXES FOR INTEGER DATA -----------------------------
    ...
    integer, parameter :: fi_temp1       = 13
    integer, parameter :: fi_temp2       = 14    
    integer, parameter :: fi_idx_max     = 14    ! 
...
!%  elemMR ARRAY COLUMN INDEXES FOR REAL DATA --------------------------------    
    ...
    integer, parameter :: eMr_Flowrate_u1   = eMr_idx_base1 + 1    ! Q in the u1 branch
    integer, parameter :: eMr_Flowrate_u2   = eMr_idx_base1 + 2   
    integer, parameter :: eMr_Flowrate_u3   = eMr_idx_base1 + 3
    integer, parameter :: eMr_idx_base2     = eMr_idx_base1 + upstream_face_per_elemM
    
    integer, parameter :: eMr_Flowrate_d1   = eMr_idx_base2 + 1
    integer, parameter :: eMr_Flowrate_d2   = eMr_idx_base2 + 2
    integer, parameter :: eMr_Flowrate_d3   = eMr_idx_base2 + 3  
    integer, parameter :: eMr_idx_base3     = eMr_idx_base2 + dnstream_face_per_elemM
 
    integer, parameter :: eMr_Velocity_u1   = eMr_idx_base3 + 1    ! Q in the u1 branch
    integer, parameter :: eMr_Velocity_u2   = eMr_idx_base3 + 2   
    integer, parameter :: eMr_Velocity_u3   = eMr_idx_base3 + 3
    integer, parameter :: eMr_idx_base4     = eMr_idx_base3 + upstream_face_per_elemM

    integer, parameter :: eMr_Velocity_d1   = eMr_idx_base4 + 1
    integer, parameter :: eMr_Velocity_d2   = eMr_idx_base4 + 2
    integer, parameter :: eMr_Velocity_d3   = eMr_idx_base4 + 3  
    integer, parameter :: eMr_idx_base5     = eMr_idx_base4 + dnstream_face_per_elemM
    
    integer, parameter :: eMr_Timescale_u1  = eMr_idx_base5 + 1
    integer, parameter :: eMr_Timescale_u2  = eMr_idx_base5 + 2
    integer, parameter :: eMr_Timescale_u3  = eMr_idx_base5 + 3
    integer, parameter :: eMr_idx_base6     = eMr_idx_base5  + upstream_face_per_elemM
    
    integer, parameter :: eMr_Timescale_d1  = eMr_idx_base6 + 1
    integer, parameter :: eMr_Timescale_d2  = eMr_idx_base6 + 2
    integer, parameter :: eMr_Timescale_d3  = eMr_idx_base6 + 3
    integer, parameter :: eMr_idx_base7     = eMr_idx_base6 + dnstream_face_per_elemM
     
    integer, parameter :: eMr_Area_u1       = eMr_idx_base7 + 1
    integer, parameter :: eMr_Area_u2       = eMr_idx_base7 + 2
    integer, parameter :: eMr_Area_u3       = eMr_idx_base7 + 3
    integer, parameter :: eMr_idx_base8     = eMr_idx_base7 + upstream_face_per_elemM
    
    integer, parameter :: eMr_Area_d1       = eMr_idx_base8 + 1
    integer, parameter :: eMr_Area_d2       = eMr_idx_base8 + 2
    integer, parameter :: eMr_Area_d3       = eMr_idx_base8 + 3
    integer, parameter :: eMr_idx_base9     = eMr_idx_base8 + dnstream_face_per_elemM
    
    integer, parameter :: eMr_Topwidth_u1   = eMr_idx_base9 + 1
    integer, parameter :: eMr_Topwidth_u2   = eMr_idx_base9 + 2
    integer, parameter :: eMr_Topwidth_u3   = eMr_idx_base9 + 3
    integer, parameter :: eMr_idx_base10    = eMr_idx_base9 + upstream_face_per_elemM
    
    integer, parameter :: eMr_Topwidth_d1   = eMr_idx_base10 + 1
    integer, parameter :: eMr_Topwidth_d2   = eMr_idx_base10 + 2
    integer, parameter :: eMr_Topwidth_d3   = eMr_idx_base10 + 3
    integer, parameter :: eMr_idx_base11    = eMr_idx_base10 + dnstream_face_per_elemM
    
    integer, parameter :: eMr_Length_u1     = eMr_idx_base11 + 1
    integer, parameter :: eMr_Length_u2     = eMr_idx_base11+ 2
    integer, parameter :: eMr_Length_u3     = eMr_idx_base11 + 3
    integer, parameter :: eMr_idx_base12    = eMr_idx_base11 + upstream_face_per_elemM
    
    integer, parameter :: eMr_Length_d1     = eMr_idx_base12 + 1
    integer, parameter :: eMr_Length_d2     = eMr_idx_base12 + 2
    integer, parameter :: eMr_Length_d3     = eMr_idx_base12 + 3
    integer, parameter :: eMr_idx_base13    = eMr_idx_base12 + dnstream_face_per_elemM
    
    integer, parameter :: eMr_Zbottom_u1    = eMr_idx_base13 + 1
    integer, parameter :: eMr_Zbottom_u2    = eMr_idx_base13 + 2
    integer, parameter :: eMr_Zbottom_u3    = eMr_idx_base13 + 3
    integer, parameter :: eMr_idx_base14    = eMr_idx_base13 + upstream_face_per_elemM
    
    integer, parameter :: eMr_Zbottom_d1    = eMr_idx_base14 + 1
    integer, parameter :: eMr_Zbottom_d2    = eMr_idx_base14 + 2
    integer, parameter :: eMr_Zbottom_d3    = eMr_idx_base14 + 3
    integer, parameter :: eMr_idx_base15    = eMr_idx_base14 + dnstream_face_per_elemM
     
    integer, parameter :: eMr_BreadthScale_u1    = eMr_idx_base15 + 1
    integer, parameter :: eMr_BreadthScale_u2    = eMr_idx_base15 + 2
    integer, parameter :: eMr_BreadthScale_u3    = eMr_idx_base15 + 3
    integer, parameter :: eMr_idx_base16         = eMr_idx_base15 + upstream_face_per_elemM
    
    integer, parameter :: eMr_BreadthScale_d1    = eMr_idx_base16 + 1
    integer, parameter :: eMr_BreadthScale_d2    = eMr_idx_base16 + 2
    integer, parameter :: eMr_BreadthScale_d3    = eMr_idx_base16 + 3
    integer, parameter :: eMr_idx_base17         = eMr_idx_base16 + dnstream_face_per_elemM
     
    integer, parameter :: eMr_temp1              = eMr_idx_base17 + 1   
    integer, parameter :: eMr_temp2              = eMr_idx_base17 + 2
    integer, parameter :: eMr_temp3              = eMr_idx_base17 + 3
    integer, parameter :: eMr_temp4              = eMr_idx_base17 + 4
    integer, parameter :: eMr_temp5              = eMr_idx_base17 + 5
    integer, parameter :: eMr_temp6              = eMr_idx_base17 + 6
    
    integer, parameter :: eMr_n_temp       = 6
    integer, parameter :: eMr_idx_base18   = eMr_idx_base17 + eMr_n_temp
    integer, parameter :: eMr_idx_max      = eMr_idx_base18
    ! storage for temp array index positions
...
!%  faceR COLUMN INDEXES FOR REAL DATA ON FACE -------------------------------
    ...
    integer, parameter :: fr_Topwidth     = 6
    integer, parameter :: fr_Velocity_d   = 7 ! velocity on downstream side of face (velocityP in SvePy)
    integer, parameter :: fr_Velocity_u   = 8 ! velocity on upstream side of face (velocityM in SvePy)
    integer, parameter :: fr_Zbottom     =  9
    integer, parameter :: fr_X           = 10
    integer, parameter :: fr_temp1       = 11
    integer, parameter :: fr_temp2       = 12
    integer, parameter :: fr_temp3       = 13
    integer, parameter :: fr_temp4       = 14
    integer, parameter :: fr_idx_max     = 15
