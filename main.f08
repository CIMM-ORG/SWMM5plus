...
program main
    ...
    real(4),       dimension(:,:), allocatable, target    :: linkR       ! real data for links
    ...
    real(4),       dimension(:,:), allocatable, target    :: nodeR       ! real data for nodes
    ...
    real(4),    dimension(:),      allocatable :: wdManningsN
    real(4),    dimension(:),      allocatable :: wdLength
    real(4),    dimension(:),      allocatable :: wdZBottom
    real(4),    dimension(:),      allocatable :: wdXDistance
    real(4),    dimension(:),      allocatable :: wdBreadth
    real(4),    dimension(:,:,:),  allocatable :: wdWidthDepthData
